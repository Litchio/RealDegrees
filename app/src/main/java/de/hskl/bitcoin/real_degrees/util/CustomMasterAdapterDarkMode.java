...
public class CustomMasterAdapterDarkMode extends CursorAdapter {
    ...
    public CustomMasterAdapterDarkMode(@NonNull Context ctx, int itemLayout, @NonNull Cursor c,
    ...
    public void bindView(@NonNull View v, @NonNull Context ctx, @NonNull Cursor c) {
        ...
        // valid
        tv_state.setTextColor(ctx.getResources().getColor(R.color.white));
        tv_name.setTextColor(ctx.getResources().getColor(R.color.white));
        tv_grade.setTextColor(ctx.getResources().getColor(R.color.white));
        // set correctColor
